    ...
    public partial class photos : PhoneApplicationPage
    {
        ...
        public void bw_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            photoList.Dispatcher.BeginInvoke(() =>
            {
                ...
                image.Source = PictureDecoder.DecodeJpeg(isoStream, 150, 150);
                image.Width = 142;
                image.Height = 142;
        ...
        {
            string[] fileNames = storage.GetFileNames();
            NavigationService.Navigate(new Uri("/PicView.xaml?picName=" + /*photoList.SelectedItem*/fileNames[photoList.SelectedIndex]  , UriKind.Relative));
            fileNames = null;
        }
