    ...
    public partial class Settings : PhoneApplicationPage
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            try
            {
                ...
                fakePasswordButton.Content = "Change Fake Password";
                optionReader.Dispose();
            }
            catch { }
        ...
        private void fakePasswordButton_Click(object sender, RoutedEventArgs e)
        {
            NavigationService.Navigate(new Uri("/changeFakePassword.xaml", UriKind.RelativeOrAbsolute));
        }
    }
}